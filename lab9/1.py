...
# Музыка
pygame.mixer.music.load(r"C:\Users\user\Desktop\PP_2\lab9\elements2\background.wav")
...
# Фон
background = pygame.image.load(r"C:\Users\user\Desktop\PP_2\lab9\elements2\road.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\user\Desktop\PP_2\lab9\elements2\second.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\user\Desktop\PP_2\lab9\elements2\first.png")
...
# Монеты трех видов
coin_data = {
    r"C:\Users\user\Desktop\PP_2\lab9\elements2\coin1.png": 1,
    r"C:\Users\user\Desktop\PP_2\lab9\elements2\coin5.png": 5,
    r"C:\Users\user\Desktop\PP_2\lab9\elements2\coin10.png": 10
}
...
while not done:
    ...
    if P1.rect.colliderect(E1.rect):
        ...
        pygame.mixer.Sound(r"C:\Users\user\Desktop\PP_2\lab9\elements2\crash.wav").play()
        time.sleep(0.5)
