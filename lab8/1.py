...
# машины и все такое
glavnaya = pygame.image.load(r"lab8\mashiny\first.png")
soperniki = pygame.image.load(r"lab8/mashiny/second.png")
moneta = pygame.image.load(r"lab8\mashiny\moneta.png")
road = pygame.image.load(r"lab8\mashiny\road.png")
